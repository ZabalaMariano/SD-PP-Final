...
class Gateway {
	...
	public String getLocalPort(int puertoEscucha) throws Exception 
	{	
        Map<String, String> params = new HashMap<String, String>();
        params.put("NewRemoteHost", "");
        params.put("NewProtocol", "TCP");
        params.put("NewExternalPort", "" + puertoEscucha);
        
        Map<String, String> r = command("GetSpecificPortMappingEntry", params);
        return r.get("NewInternalPort");
	}
